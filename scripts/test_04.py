...
# Imports the Decision Tree Classifier
...
def DTreeTests(df, labels):
    ...
    dt
    dt.train(trainingData = train_data, trueLabels = labels)
    pred_labels = dt.test(testData = test_data)
...
if __name__ == "__main__":
    ...
    dt = DTreeTests(test_df, "species")

    # Finally, let's print out the decision tree to be visualized at http://mshang.ca/syntree/
    print(dt)